...
def _soft_nms(
    ...
    Implementation of [Soft-NMS -- Improving Object Detection With One Line of Code]
    ...
    return keep  #torch.tensor(idxs_out).to(boxes.device) , torch.tensor(scores_out).to(scores.device)