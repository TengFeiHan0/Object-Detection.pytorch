...
from det.layers import DFConv2d, IOULoss, NaiveGroupNorm
...
class FCOS(nn.Module):
    ...
    def compute_locations(self, features):
        locations = []#fpn返回[p2~p7]五层的features,针对每一层的feature，计算位置
    ...
    def compute_locations_per_level(self, h, w, stride, device):
        ...
        shift_y, shift_x = torch.meshgrid(shifts_y, shifts_x)#h*w的网格
